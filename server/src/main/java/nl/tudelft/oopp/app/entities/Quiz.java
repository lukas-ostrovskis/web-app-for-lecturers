...
public class Quiz {
     ...
     * Since answers don't actually need to be separated from other
     * data about the quiz and will always be
     * pulled together, there's no real need for a separate table
    ...
    public Quiz(String roomId, String question,
                ...
                String answerF, String answerG, String answerH, String answerI, String answerJ,
                char correctAnswer) {
        this.roomId = roomId;
     ...
     * @param answerA - answerA
     * @param answerB - answerB
     * @param answerC - answerC
     * @param answerD - answerD
     * @param answerE - answerE
     * @param answerF - answerF
     * @param answerG - answerG
     * @param answerH - answerH
     * @param answerI - answerI
     * @param answerJ - answerJ
     * @param correctAnswer - correctAnswer
     * @param used - used
     * @param open - open
     * @param answerDistributionReady - answerDistributionReady
     */
     ...
     *
     * @param answerDistributionReady the answer distribution
     *                                  status (whether it's ready to be shown).
     */
